...
export const apiAdmin = {
    apiAdminChangePassword: async (user, oldPassword, newPassword, axiosJWT) => {
        try {
            const res = await axiosJWT.post(
                "/api/admin/change-password-admin",
                {
                    email: user?.email,
    ...
    apiAdminChangeInformation: async (user, data, axiosJWT) => {
        try {
            const res = await axiosJWT.post(
                "/api/admin/change-information-admin",
                {
                    email: user?.email,
    ...
    apiAdminGetInformation: async (user, dispatch, axiosJWT) => {
        try {
            const res = await axiosJWT.post(
                "/api/admin/get-information-admin",
                {
                    email: user?.email,
                },
                {
...
export const apiStudent = {
    apiStudentChangePassword: async (user, oldPassword, newPassword, axiosJWT) => {
        try {
            const res = await axiosJWT.post(
                "/api/admin/change-password-student",
                {
                    email: user?.email,
                    oldPassword: oldPassword,
                    newPassword: newPassword,
    ...
    apiStudentChangeInformation: async (user, data, axiosJWT) => {
        try {
            const res = await axiosJWT.post(
                "/api/admin/change-information-student",
                {
                    email: user?.email,
                    fullName: data?.fullName,
                    numberPhone: data?.numberPhone,
    ...
    apiStudentGetInformation: async (user, dispatch, axiosJWT) => {
        try {
            const res = await axiosJWT.post(
                "/api/admin/get-information-student",
                {
                    email: user?.email,
                },
                {
