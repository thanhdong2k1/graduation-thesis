                ...
                <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 border border-blue-gray-100 shadow-sm">
                    ...
                    <div class="p-4 text-right">
                        <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">
                            Tổng sinh viên bộ môn
                        </p>
                        <h4 class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                            {statistic?.statisticTotalStudentDepartment ?? "???"}
                        </h4>
                    </div>
                </div>
                <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 border border-blue-gray-100 shadow-sm">
                    ...
                    <div class="p-4 text-right">
                        <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">
                            Tổng giảng viên bộ môn
                        </p>
                        <h4 class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                            {statistic?.statisticTotalLecturerDepartment ?? "???"}
                        </h4>
                    </div>
                </div>
                <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 border border-blue-gray-100 shadow-sm">
                    ...
                    <div class="p-4 text-right">
                        ...
                        <h4 class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                            {statistic?.statisticTotalThesisDeparment ?? "???"}
                        </h4>
                    </div>
                    <div class="border-t border-blue-gray-50 p-4">
                        <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                            <strong
                                class={`${
                                    statistic?.statisticThesisDepartmentAvailabeResult ==
                                    statistic?.statisticTotalThesisDeparment
                                        ? "text-green-500"
                                        : "text-red-500"
                                }`}
                ...
                <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 border border-blue-gray-100 shadow-sm">
                    ...
                    <div class="border-t border-blue-gray-50 p-4">
                        <strong
                            class={`${
                                statistic?.statisticThesisDepartmentAvailabeResult ==
                                statistic?.statisticThesisDepartmentSuccessResult
                                    ? "text-green-500"
                                    : "text-red-500"
                            }`}
                        >
