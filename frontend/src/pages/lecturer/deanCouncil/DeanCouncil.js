...
const DeanCouncil = () => {
    ...
    const handleEdit = (data) => {
        navigate(`../${pathRoutes?.R1?.updateCouncil}/${data?.councilData?.id}`, {
            replace: true,
        });
    };
    const handleDetail = (data) => {
      // console.log(pathRoutes?.R1?.councilDetail)
        navigate(`../${pathRoutes?.R1?.councilDetail}/${data?.councilData?.id}`, {
            replace: true,
        });
    };
        ...
        await apiLecturer
            ...
            .then((res) => {
                if (res?.errCode == 0) {
                    ...
                    // reset();
                    apiLecturer.getAllDeanCouncils({
                        user: currentUser,
    ...
    const tableData = [
        ...
        },
        {
            ...
            width: "w-[300px]",
            maxWidth: "max-w-[300px]",
            column: "councilData.thesisSessionId",
            columnData: "councilData.thesisSessionData.name",
            // hide: true,s
        },
        {
